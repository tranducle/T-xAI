...
def main()->int:
    ...
    g6={
      ...
      'verdict':verdict,'input_artifacts':['results/E10_delta_z_bridge.json','results/E11_m3_evidence_channel.json'],
    ...
    g8={
      ...
      'input_artifacts':['results/gates/G0_data_provenance.json','results/gates/G1_preprocessing_integrity.json','results/gates/G2_baseline_sanity.json','results/E10_delta_z_bridge.json','results/E11_m3_evidence_channel.json','results/gates/G6_acceptance_result_integrity.json'],
