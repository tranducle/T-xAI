...
Usage: python3 run_kernel_constant.py
"""
...
from txai.config import ACTIONS, GROUP_NAMES  # noqa: E402
from txai.pipeline import KERNEL_TEMPERATURES  # noqa: E402
from txai.release import ResponseKernel, sharp_kernel  # noqa: E402
...
def main() -> int:
    ...
    for name in ("treeshap", "lime", "random", "constant"):
        ...
        if not path.exists():
            continue
        rows = json.loads(path.read_text())["E5_bridge"]["rows"]
